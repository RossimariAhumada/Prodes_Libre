...
<header class="bg-danger text-white text-center py-1">
    <h3 class="display-5 fw-bold">CALIDAD DE EDUCACIÓN</h3>
...
<div class="container my-5">
    <div class="row">
        ...
        <div class="col-md-8">
            <img src="<?php echo PUBLIC_PATH; ?>img/calidad-de-educacion.jpg" class="img-fluid">
            ...
            <h2 class="mt-3 small-space">Calidad de Educación</h2>
