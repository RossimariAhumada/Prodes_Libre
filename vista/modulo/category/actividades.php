...
<header class="bg-danger text-white text-center py-1">
    <h3 class="display-5 fw-bold">ACTIVIDADES</h3>
            ...
            <div class="custom-col">
                <div class="custom-card">
                    ...
                    <div class="custom-card-body">
                        <h5 class="custom-card-title">ACTIVIDAD</h5>
                        <p class="custom-card-text">Lorem Ipsum es simplemente el texto de relleno de las imprentas y
                            archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de...</p>
                        <a href="#" class="custom-card-link">Ver más</a>
                    </div>
                </div>
            </div>
            <div class="custom-col">
