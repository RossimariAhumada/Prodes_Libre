...
<nav class="navbar navbar-light bg-white py-3">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <form class="d-flex flex-grow-1 justify-content-center mx-5">
            <input class="form-control form-control-lg me-0" type="search" placeholder="Buscar.." aria-label="Search" style="width: 65%; border-radius: 30px;">
            <button class="btn btn-color-btn" type="submit" style="background-color: #C60909; border-radius: 30px;">
...
<nav class="navbar navbar-expand-lg navbar-light bg-white">
    <div class="container-fluid justify-content-center">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-color-btn active" aria-current="page" href="<?php echo BASE_URL . 'inicio'; ?>" style="color: #C60909; font-weight: bold;">INICIO</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo BASE_URL . 'Category' . DS . 'entrada_ods'; ?>" style="color: #333; font-weight: bold;">ODS</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo BASE_URL . 'Category' . DS . 'actividades'; ?>" style="color: #333; font-weight: bold;">ACTIVIDADES</a>
                </li>
                <li class="nav-item">
