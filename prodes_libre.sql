...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-11-2024 a las 06:26:02
...
(1, 'Limpieza', 'Limpieza', '2024-11-23', '2024-11-26', 'Limpieza cero', 'limpieza.png', 30, 3);
...
(2, 'Fin de la pobreza', 'si e puede dejar la pobreza', 'fin de la pobreza.pdf', '2024-10-20', '2024-10-30', '1000000.00', 'si se puede', 'Colombia', 1, 1, 1),
(3, 'Voluntad de vida', 'Voluntad', 'voluntad de vida.pdf', '2024-10-20', '2025-10-20', '15000000.00', 'Buscar y asesorar para dar voluntad de vida', 'Colombia', 3, 1, 2);
...
INSERT INTO `compras` (`id_pago`, `id_prdcto`, `id_ods`, `id_usuario`, `valor_prdcto`, `fecha_compra`) VALUES
(7, 5, 4, 1, '367200', '2024-11-25 00:26:59'),
(8, 7, 1, 1, '460000', '2024-11-25 00:34:15'),
(9, 8, 3, 1, '270000', '2024-11-25 00:34:32'),
(10, 4, 4, 1, '800000', '2024-11-25 19:35:48'),
(11, 4, 4, 1, '800000', '2024-11-25 19:53:57');
